...
DATA_DIR=/data/datasets/cheng/mrc-for-ner-medical/2022n2c2/2022n2c2_track2/data/mrc_text_attribute_merge/
...
OUTPUT_DIR=${OUTPUT_BASE}/model/${FILE}_${BATCH}_${GRAD_ACC}_${WEIGHT_DECAY}_${LR}_${MAX_EPOCH}_'merge'_'text'
mkdir -p ${OUTPUT_DIR}
