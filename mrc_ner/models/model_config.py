...
class DebertaQueryNerConfig(DebertaConfig):
    def __init__(self, **kwargs):
        super(DebertaQueryNerConfig, self).__init__(**kwargs)
        self.mrc_dropout = kwargs.get("mrc_dropout", 0.1)
        self.classifier_intermediate_hidden_size = kwargs.get("classifier_intermediate_hidden_size", 768)
        self.classifier_act_func = kwargs.get("classifier_act_func", "gelu")
